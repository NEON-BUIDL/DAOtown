...
MAX_TRIANGLES = mean_triangles + std_dev_triangles * 2
MAX_DRAWCALLS = mean_drawcalls + std_dev_drawcalls * 2

# Cria um arquivo markdown e escreve o cabeçalho.
markdown_path = Path(__file__).parent / 'medicoes.md'
with open(markdown_path, 'w') as f:
    f.write('# Métricas de Modelos 3D\n\n')
    f.write(f'Máximo de triângulos permitidos: {MAX_TRIANGLES}\n')
    f.write(f'Máximo de chamadas de desenho permitidas: {MAX_DRAWCALLS}\n')
